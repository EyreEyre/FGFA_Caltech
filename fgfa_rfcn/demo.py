...
def main():
    ...
    for file in sorted(glob.glob(cur_path + '/../demo/data/*')):
        print "file:", file

        if os.path.basename(file) not in ['ILSVRC2015_val_00003001', 'ILSVRC2015_val_00007010',\
                                          'ILSVRC2015_val_00082001', 'ILSVRC2015_val_00100001', \
                                          'ILSVRC2015_val_00110000', 'ILSVRC2015_val_00127006', \
                                          'ILSVRC2015_val_00159002', 'ILSVRC2015_val_00173004',\
                                          ]:

            # file = 'ILSVRC2015_val_00007010'
            # output_dir = cur_path + '/../demo/output/' + file + '/'

            output_dir = cur_path + '/../demo/output/' + os.path.basename(file) + '/'
            # print "output_dir", output_dir
            if not os.path.exists(output_dir):
                os.makedirs(output_dir)

            # image_names = glob.glob(cur_path + '/../demo/' + file + '/*.JPEG')
            image_names = glob.glob(file + '/*.JPEG')
