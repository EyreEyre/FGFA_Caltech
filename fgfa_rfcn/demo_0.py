...
def main():
    ...
    model = '/../model/rfcn_fgfa_30.98/fgfa_rfcn_vid'
    ...
    image_names = sorted(glob.glob(cur_path + '/../demo/set09_V009/*.JPEG'))
    output_dir = cur_path + '/../demo/rfcn_fgfa_sorted_30.98/'
    ...
    arg_params, aux_params = load_param(cur_path + model, 2, process=True)

    feat_predictors = Predictor(feat_sym, data_names, label_names,
                          context=[mx.gpu(2)], max_data_shapes=max_data_shape,
